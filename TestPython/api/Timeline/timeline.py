...
# ids为None
def timelineIdsNone():
    data = {"ids": None, "start_time": 1478016000, "end_time": 1478102399}
    return ApiMethod.testMethod(timelineUrl, type, data, cookie)


# 开始时间为None
def timelineSTNone():
    data = {"ids": "898602B12616C0613882,89860042191586153394", "start_time": None, "end_time": 1478102399}
    return ApiMethod.testMethod(timelineUrl, type, data, cookie)


# 结束时间为None
def timelineETNone():
    data = {"ids": "898602B12616C0613882,89860042191586153394", "start_time": 1478016000, "end_time": None}
    return ApiMethod.testMethod(timelineUrl, type, data, cookie)


# ids为空
def timelineIdsEmpty():
    data = {"ids": "", "start_time": 1478016000, "end_time": 1478102399}
    return ApiMethod.testMethod(timelineUrl, type, data, cookie)


# 开始时间为空
def timelineSTEmpty():
    data = {"ids": "898602B12616C0613882,89860042191586153394", "start_time": "", "end_time": 1478102399}
    return ApiMethod.testMethod(timelineUrl, type, data, cookie)


# 结束时间为空
def timelineETEmpty():
    data = {"ids": "898602B12616C0613882,89860042191586153394", "start_time": 1478016000, "end_time": ""}
    return ApiMethod.testMethod(timelineUrl, type, data, cookie)
...
# 开始时间字段缺失
def timelineNoST():
    data = {"ids": "898602B12616C0613882,89860042191586153394", "end_time": 1478102399}
    return ApiMethod.testMethod(timelineUrl, type, data, cookie)
