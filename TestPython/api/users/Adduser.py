...
def AdduserNoCookie():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "password": "123456", "role_id": "531", "tids": ["3E428007AF", "3728800381"]}
...
def AdduserMNone():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": None, "password": "123456", "role_id": "531", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserPwdNone():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "password": None, "role_id": "531", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserRIdNone():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "password": "123456", "role_id": None, "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserMEmpty():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "", "password": "123456", "role_id": "531", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserPwdEmpty():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "password": "", "role_id": "531", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserRIdEmpty():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "password": "123456", "role_id": "", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserNoPwd():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "role_id": "531", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserNoRId():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "password": "123456", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserPwdSmall():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "12345", "password": "1234", "role_id": "531", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
...
def AdduserRIdError():
    data = {"email": "49819@qq.com", "first_name": "ying", "last_name": "tao", "week": [0, 1, 2, 3, 4, 5, 6],
            "phone": "123456", "password": "123456", "role_id": "4", "tids": ["3E428007AF", "3728800381"]}
    return ApiMethod.testMethod(userUrl, type, data, cookie)
